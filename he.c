...
#define ikram 100 // Define the maximum number of tasks with the name 'ikram'

char tasks[ikram][100]; // Use a two-dimensional array to store task descriptions
int kawtharIkram = 0; // Use kawtharIkram to keep track of the number of tasks
